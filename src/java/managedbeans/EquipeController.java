...
import sessionbeans.EquipeFacade;
...
public class EquipeController implements Serializable {
    ...
    @EJB
    private sessionbeans.EquipeFacade ejbFacade;
    ...
    public String viewList() {
        recreateModel();
        return "/jsf/equipe/List";
    }

    public String prepareView() {
        current = (Equipe) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage("L'equipe :  " + current.getAcronyme(), "a été bien crée");
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage("L'equipe :  " + current.getAcronyme(), "a été bien modifié");
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("EquipeDeleted"), current.getAcronyme());
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public static class EquipeControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Equipe) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Equipe.class.getName());
            }
        }
