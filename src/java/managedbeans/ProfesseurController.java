...
import sessionbeans.ProfesseurFacade;
...
public class ProfesseurController implements Serializable {
    ...
    @EJB
    private sessionbeans.ProfesseurFacade ejbFacade;
    ...
    public String viewList() {
        recreateModel();
        return "/jsf/professeur/List";
    }

    public String prepareView() {
        current = (Professeur) getItems().getRowData();
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage("Les informations du professeur :  " + current.getNom(), "ont été bien modifié");
            return "List";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ProfesseurDeleted"), current.getNom());
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public static class ProfesseurControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Professeur) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Professeur.class.getName());
            }
        }
