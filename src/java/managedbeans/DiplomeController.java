...
import beans.Diplome;
import managedbeans.util.JsfUtil;
import managedbeans.util.PaginationHelper;
import sessionbeans.DiplomeFacade;
...
public class DiplomeController implements Serializable {
    ...
    @EJB
    private sessionbeans.DiplomeFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("DiplomeCreated"),current.getIntitule());
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("DiplomeUpdated"),current.getIntitule());
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("DiplomeDeleted"),current.getIntitule());
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public static class DiplomeControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Diplome) {
                ...
                return getStringKey(o.getIdDiplome());
            } else {
