...
public class LaboratoireController implements Serializable {
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage("Le laboratoire :  " + current.getAcronyme(), "a été bien crée");
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage("Le laboratoire :  " + current.getAcronyme(), "a été bien modifié");
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("LaboratoireDeleted"),current.getAcronyme());
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
